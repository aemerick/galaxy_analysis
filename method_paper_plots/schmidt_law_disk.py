...
plt.tight_layout()
fig.savefig('atomic_schmidt_law_evolution_disk.png')
plt.close()
...
ax.set_yticks([])
#plt.tight_layout()
fig.savefig('overplot_roychowdhury_2014_f8_disk.png')
plt.close()
...
fig.set_size_inches(8,8)
plt.tight_layout()
fig.savefig('all_gas_schmidt_law_evolution_disk.png')
plt.close()
...
fig.set_size_inches(8,8)
plt.tight_layout()
fig.savefig('all_gas_efficiency_evolution_disk.png')
plt.close()
