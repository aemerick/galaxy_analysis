...
#                                         outname = 'G_o_r_cell_mass_2D_phase.png',
    ...
    if 'Q_o' in plots:
        pd = tapd.time_average_phase_diagram(t_min, t_max,
                                     ...
                                     y_bins = np.logspace(-9, -1, nbin)*yt.units.erg/yt.units.s/yt.units.cm**2, yfield = 'Q0_flux',
                                     region_type = 'Disk', region_kwargs = {'normal':np.array([0.0,0.0,1.0]),
                                                                           'radius': 600*yt.units.pc,
                                                                           'height': 8.0*yt.units.pc,
                                                                            'center': np.array([0.5,0.5,0.5])},
...
if __name__ == "__main__":
    ...
    plot_time_average_PD('./', t_min, t_max, nbin = 100, plots = ['nT','G_o','Q_o'])
